...
namespace DotNetNuke.Modules.groupdocs_dnn_installable_annotation
{
    ...
    /// are accessible to your module's controls (that inherity from groupdocs_dnn_installable_annotationSettingsBase
    /// 
    /// </summary>


    public class groupdocs_dnn_installable_annotationSettingsBase : ModuleSettingsBase
    {
